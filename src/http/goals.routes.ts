...
import { RegisterGoalSchema, ReturnGoalListValidated, UpdateGoalSchema, UpdateGoalValueSchema } from "./schemas/goalsSchema";
...
export async function  GoalsRoutes(app:FastifyInstance) {
    ...
    app.withTypeProvider<ZodTypeProvider>().put("/complete",MarkGoalAsCompletedControler)
}